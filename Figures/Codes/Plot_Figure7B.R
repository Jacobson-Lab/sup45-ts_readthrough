...
pc2 <- read.table("../Data/Data_Figure7B.txt", header = TRUE)
...
f7b <- pp + geom_text(data = mod_df, aes(x = x, y = y, label = mod), hjust = 1, parse = TRUE, size = 2) + 
  coord_cartesian(clip = "off")

# Save plot
ggsave(filename = "Figure7B.pdf", plot = f7b, height = 3, width = 6.5, units = "in", dpi = 500, path = "../Plots/")  
