...
df <- read.table("../Data/Data_Figure8.txt", header = TRUE)
...
# Plot
f8 <- ggplot(df, aes(x = value, y = log_rte)) +
...
# Save plot
ggsave(filename = "Figure8.pdf", plot = f8, path = "../Plots/", height = 3, width = 6, units = "in", dpi = 500)
ggsave(filename = "Figure8_eps.eps", plot = f8, path = "../Plots/", height = 3, width = 6, units = "in", dpi = 500)
